	...
	<div class="responsive">
		...
		<div class="mainSquare">
			...
			<div class="row top">
				...
				<div id="clickable" data-id="go" class="square2 ">
					<span data-id="go" class="corner corner3">collect<br />$200 salary<br />as you pass</span>
				</div>
			</div>
...
import ViewProperty from '@/components/gameBoard/viewProperty/ViewProperty.vue';
